...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <h4>To access your account, please re-enter your username and password and then click on the "Login" button. If you have not registered, enter your information and click on the "Sign Up" button to create an account.</h4>
      <br>
    </div>
  </div>
</div>
